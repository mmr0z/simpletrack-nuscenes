...
parser.add_argument('--scene', type=str, default=None, help='optional single validation scene name')
...
if __name__ == '__main__':
    ...
    if args.scene is not None:
        if args.scene not in val_scene_names:
            parser.error('--scene must name a nuScenes validation scene')
        val_scene_names = [args.scene]
